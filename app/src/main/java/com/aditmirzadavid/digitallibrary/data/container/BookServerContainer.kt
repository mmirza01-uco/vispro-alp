...
object BookServerContainer {
    ...
    val bookService: BookServerService =
        retrofit.create(BookServerService::class.java)

    // Membuat instance repository
    // yang akan digunakan oleh ViewModel
    val bookRepository = BookServerRepository(bookService)
